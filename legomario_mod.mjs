  ...
  _createClass(MarioBaseBlocks, [{
    ...
    value: function setupTranslations(formatMessage) {
      _setupTranslations(formatMessage, {
        ...
        'ru': {
          'legomario.whenBarcode': 'когда штрихкод равен [BARCODE]',
          'legomario.whenAnyBarcode': 'когда любой штрихкод найден',
          'legomario.getBarcode': 'штрихкод',
          'legomario.whenColor': 'когда цвет равен [SENSOR_COLOR]',
          'legomario.isColor': 'цвет равен [SENSOR_COLOR] ?',
          'legomario.getColor': 'цвет',
          'legomario.whenPants': 'когда штаны равны [PANTS]',
          'legomario.isPants': 'штаны равны [PANTS] ?',
          'legomario.getPants': 'штаны',
          'legomario.setVolume': 'установить звук на [VOLUME] %',
          'legomario.white': '(19) Белый',
          'legomario.red': '(21) Красный',
          'legomario.blue': '(23) Синий',
          'legomario.yellow': '(24) Желтый',
          'legomario.black': '(26) Черный',
          'legomario.green': '(37) Зеленый',
          'legomario.brown': '(106) Коричневый',
          'legomario.purple': '(268) Фиолетовый',
          'legomario.nougatBrown': '(312) Нуга',
          'legomario.cyan': '(322) Голубой',
          'legomario.pants.none': '(0) Без штанов',
          'legomario.pants.bee': '(3) Пчела',
          'legomario.pants.luigi': '(5) Луиджи',
          'legomario.pants.frog': '(6) Лягушка',
          'legomario.pants.tanooki': '(10) Тануки',
          'legomario.pants.propeller': '(12) Пропеллер',
          'legomario.pants.cat': '(17) Кошка',
          'legomario.pants.fire': '(18) Огонь',
          'legomario.pants.penguin': '(20) Пингвин',
          'legomario.pants.peach': '(24) Пич',
          'legomario.pants.mario': '(33) Марио',
          'legomario.pants.builder': '(34) Строитель',
          'legomario.pants.ice': '(35) Лед'
        },
        'ja': {
